...
> https://packages.guix.gnu.org/search/?query=opencog
> 
> implement https://packages.guix.gnu.org/packages/* where * is:
> 
> /opencog/0.1.4-1.ceac905/
> Framework for integrated AGI
> 
> /cogserver/0-2.ec5f3b9/
> OC network server
> 
> /cogutil/2.0.3-1.b07b41b/
> Low-level C++ prog utilities used by OC components
> 
> /atomspace/5.0.3-1.86c848d/
> OC hypergraph db, query system and rule engine
> 
> /attention/0-1.87d4367/
